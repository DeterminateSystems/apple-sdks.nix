...
{ libs, frameworks }: with libs; with frameworks;
{
  ...
  CoreAudioKit = { inherit AVFAudio AVFoundation AppKit AudioUnit Cocoa CoreAudio CoreData CoreFoundation CoreGraphics CoreImage CoreMIDI CoreMedia Foundation IOKit Metal QuartzCore UniformTypeIdentifiers simd; };
