...
{ libs, frameworks }: with libs; with frameworks;
{
  ...
  GroupActivities = { inherit AVFoundation Combine CoreGraphics CryptoKit Foundation Network; };
  Hypervisor = { };
  ...
  WebKit = { inherit AppKit CoreData CoreFoundation CoreGraphics CoreImage Foundation IOKit JavaScriptCore Metal OpenGL QuartzCore; };
