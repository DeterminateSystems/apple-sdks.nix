...
{ libs, frameworks }: with libs; with frameworks;
{
  ...
  AppKit                           = { inherit Accessibility ApplicationServices Cocoa CoreData CoreFoundation CoreGraphics CoreImage CoreTransferable DeveloperToolsSupport Foundation IOKit Metal OSLog OpenGL QuartzCore Symbols UniformTypeIdentifiers; };
  ...
  AuthenticationServices           = { inherit AppKit CoreData CoreFoundation CoreGraphics CoreImage CryptoKit DeveloperToolsSupport Foundation IOKit Metal QuartzCore Security Symbols; };
  ...
  CoreAudio                        = { inherit CoreAudioTypes CoreFoundation Foundation; };
  ...
  CreateML                         = { inherit AVFoundation Combine CoreFoundation CoreGraphics CoreImage CoreML CoreMedia CoreVideo CreateMLComponents Foundation IOKit ImageIO Metal MetalPerformanceShaders NaturalLanguage TabularData UniformTypeIdentifiers VideoToolbox Vision simd; };
  ...
  FinanceKit                       = { inherit Accelerate Contacts CoreData CoreFoundation CoreGraphics CoreLocation CoreServices CryptoKit ExtensionFoundation Foundation IOKit ImageIO OSLog Security System UniformTypeIdentifiers UserNotifications simd; };
  FinanceKitUI                     = { inherit AppKit Combine Contacts CoreData CoreGraphics CoreImage CoreLocation CoreSpotlight CoreTransferable CryptoKit DeveloperToolsSupport ExtensionKit FinanceKit Foundation SwiftUI WidgetKit; };
  ...
  SoundAnalysis                    = { inherit AVFAudio AVFoundation CoreAudio CoreFoundation CoreGraphics CoreMIDI CoreML CoreMedia Foundation IOKit Metal QuartzCore UniformTypeIdentifiers simd; };
  ...
  VideoSubscriberAccount           = { inherit CoreFoundation Foundation IOKit; };
