...
let
  ...
  thisFrameworksStdenv = mkStdenv stdenv;

  stdenvs =
    { stdenv = thisFrameworksStdenv; }
  ...
  packages =
    ...
    // {
      ...
      #   indirection?
      configd = frameworks.SystemConfiguration;
      inherit (frameworks) IOKit;

      xcodebuild = pkgs.xcbuild.override {
        stdenv = thisFrameworksStdenv;
        inherit (frameworks) CoreServices CoreGraphics ImageIO;
      };
      ...
      // rec {
        inherit (packages) xcodebuild rustPlatform;
